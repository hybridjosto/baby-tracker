...
- make editing the sleep duration easier (hours + minutes) as inputting only minutes is hard to parse.
- align the milk express ledger page format (menu + general look and feel) to the rest of the app.
- in dark mode and starting the sleep event, the font colour is not readable
